    ...
    >
      <TooltipProvider delayDuration={300}>
          ...
          <Link href="/">
            {isCollapsed ? (
              ...
              <div className="flex items-center gap-1 mt-2">
                ...
                <span className="text-sm text-gray-400 ml-1">Connect</span>
              </div>
            )}
          </Link>
        ...
        <div className={cn("border-t border-neutral-800 pt-4 mt-2 pb-4", isCollapsed ? "px-2" : "px-4")}>
          ...
          {!isCollapsed && (
            <>
              <div className="text-sm text-emerald-400 font-medium">28hub Connect</div>
              <div className="text-xs text-neutral-500 mt-1">
                © {new Date().getFullYear()} 28hub Connect - Powered by Evolution API + EvoAI
              </div>
            </>
          )}
        </div>
